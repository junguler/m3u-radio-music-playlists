...
this repo now has a [github page](https://junguler.github.io/m3u-radio-music-playlists/), it's a simple grid view of all the raw files in the repo, clicking on any of the names takes you to the raw stream file in the repo
